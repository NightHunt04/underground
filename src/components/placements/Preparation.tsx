    ...
    <div className="mt-5 w-[80%] rounded-lg flex flex-col gap-5 items-start justify-start mb-36">
        <div className="flex flex-col items-start justify-start p-5 bg-white drop-shadow-lg rounded-lg w-full">
            ...
            <div className="mt-12 flex items-center justify-between w-full p-5">
                <div onClick={() => setIsMockInterview(true)} className="hover:cursor-pointer hover:bg-gray-100 py-10 rounded-xl transition-all flex flex-col items-center justify-center w-full">
        ...
        {/* set role and skills */}
        {isMockInterview && <div className="relative flex flex-col items-start justify-start p-5 bg-white drop-shadow-lg rounded-lg w-full">
            <button onClick={() => {
                setIsMockInterview(false)
                setRole('')
                setSkills('')
